%ODT depth and trapping frequencies. Waists given here are based off
%of measurged values.
...
Vdip_Atom = 2*3*pi*c^2/(2*w0^3)*(gamma/(w0 - w) + gamma/(w0 + w))*Int;
...
fprintf('Omega_x = (2pi) %0.1f KHz \n',fx0/1e3);
fprintf('Omega_y = (2pi) %0.1f KHz \n',fy0/1e3);
fprintf('Omega_z = (2pi) %0.1f KHz \n\n',fz0/1e3);
